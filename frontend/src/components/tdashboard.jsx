      ...
      const doubled = this.state.data.map((number) => (
        <div>
          <div class="row align-items-center no-gutters">
            <div class="col mr-2">
              <h6 class="mb-0">
                <strong>{number.data}</strong>
              </h6>
              <span class="text-xs">{this.funcdate(number.date)}</span>
            </div>
            <div class="col-auto">
              <a
      ...
      const doubled = this.state.quotess.map((number) => (
        <div class="carousel-item">
          <img
            class="d-block w-100"
            style={{ height: "300px" }}
            src="https://images.pexels.com/photos/220182/pexels-photo-220182.jpeg?auto=compress&cs=tinysrgb&dpr=2&w=500"
            alt="First slide"
          />
          <div class="ss">
        ...
        <div id="wrapper">
          ...
          >
            ...
            <li className="nav-item">
              <Link
                to="/testhistory"
                onClick={() => this.props.setHist(this.state.hhistory)}
                className="nav-link active"
              >
                {" "}
                <i className="fas fa-fw fa-list-alt"></i> Detailed Test Results
              </Link>
            </li>
            <li className="nav-item">
                      ...
                      >
                        ...
                        <div>
                          ...
                          <span className="font-weight-bold">
                            Practice test to enhance your skill in java is here!
                          </span>
                        </div>
                      </a>
                      <a
                  ...
                  <li className="nav-item dropdown no-arrow mx-1">
                    ...
                    >
                      ...
                      >
                        ...
                        <div className="font-weight-bold">
                          <div className="text-truncate">
                            Hi there! Can u send me the solution of Tower Of
                            Hanoi?
                          </div>
                          <div className="small text-gray-500">
                            Shivani Goyal
                      ...
                      >
                        ...
                        <div>
                          <div className="text-truncate">
                            Help!!Redux is not getting installed?
                          </div>
                          <div className="small text-gray-500">
                            Shivesh Gupta
                          </div>
                      ...
                      >
                        ...
                        <div>
                          <div className="text-truncate">
                            When Will some good companies come to campus?
                          </div>
                          <div className="small text-gray-500">
                            Shivika Singla
                          </div>
                        ...
                        <div className="row no-gutters align-items-center">
                          <div className="col mr-2">
                            <Link
                              to="/testhistory"
                              onClick={() =>
                                this.props.setHist(this.state.hhistory)
                              }
                              className="text-xs font-weight-bold text-primary text-uppercase mb-1"
                            >
                              Previous Tests Uploaded
                            </Link>
                    ...
                    <div className="card shadow mb-4">
                      <div className="card-header py-3 d-flex flex-row align-items-center justify-content-between">
                        <h6 className="m-0 font-weight-bold text-primary">
                          Student's Result Of Last Uploaded Exam
                        </h6>
                    ...
                    <div className="card shadow mb-4">
                      <div className="card-header py-3 d-flex flex-row align-items-center justify-content-between">
                        ...
                        <a
                          ...
                          rel="nofollow"
                        >
                          <i class="icon ion-android-add text-white"></i>
                        </a>
                      </div>
                      <div
                        className="card-body"
                  ...
                  <div className="col-lg-6 mb-4">
                    ...
                    <div class="card shadow mb-4" style={{ height: "403px" }}>
                      <div class="card-header py-3">
                        ...
                        <div
                          className="row mt-2 mb-2 p-3"
                          style={{ background: "rgb(0, 140, 186)" }}
                        >
                  ...
                  <div className="col-lg-6 mb-4">
                    <div className="card shadow mb-4">
                      ...
                      <div className="card-body">
                        ...
                        <p>
                          One Click Upload Exam!!!Easy, Convinient And User
                          Friendly Environment
                        </p>
                        <Link to="testdataentry">
                          {" "}
                          Click Here To Upload Exam &rarr;
                        </Link>
                      </div>
                    </div>
                    ...
                    <div className="card shadow mb-4">
                      <div className="card-header py-3">
                        <h6 className="m-0 font-weight-bold text-primary my-auto">
                          Quote For The Day
                          <button
          ...
          <div class="modal-dialog" role="document">
            <div class="modal-content">
              <div class="modal-header bg-info">
                <h5 class="modal-title text-gray-800" id="exampleModalLabel">
                  ADD NEW NOTICE
                </h5>
                <button
                  class="close"
              ...
              <div class="modal-footer">
                ...
                <button
                  ...
                  onClick={() =>
                    this.nnotice(document.getElementById("notice01").value)
                  }
                >
                  ADD
                </button>
          ...
          <div class="modal-dialog" role="document">
            <div class="modal-content">
              ...
              <div class="modal-footer">
                ...
                <button class="btn btn-primary" onClick={() => this.delete()}>
                  DELETE
                </button>
              </div>
            </div>
            ...
            <div class="modal-content">
              ...
              <div class="modal-footer">
                ...
                <button
                  class="btn btn-primary"
                  onClick={() =>
                    this.quote(document.getElementById("quote01").value)
                  }
                >
                  ADD
                </button>
